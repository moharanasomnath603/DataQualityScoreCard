package dqs.ccdri.workflow.luhn;

/**
 * @author somohara
 * 
 * Luhn Algorithm that will legitimate the Account number if Valid or Invalid
 *  
 */

public final class CardUtils {

	public static boolean cardValiditychk(long cnumber) {
		return (thesize(cnumber) >= 13 && thesize(cnumber) <= 19) && (prefixmatch(cnumber, 4)
				|| prefixmatch(cnumber, 5) || prefixmatch(cnumber, 37) || prefixmatch(cnumber, 6) || prefixmatch(cnumber, 3))
